...
?>
	...
	<head>
		<title>RSW | Admin Dashboard</title>
		...
		<div class="page-container">
			...
			<div class="left-content">
				<div class="mother-grid-inner">
							...
							<div class="col-md-3 four-grid">
								<div class="four-w3ls">
									...
									<div class="four-text">
										...
										<?php $sql7 = "SELECT id from tblcarwashbooking  where status='pending'";
										$query7 = $dbh->prepare($sql7);
										$query7->execute();
										$results1 = $query7->fetchAll(PDO::FETCH_OBJ);
										$pendingbookings = $query7->rowCount();
										?>
										<h4><?php echo htmlentities($pendingbookings); ?></h4>
									</div>
								</div>
							</div>
							...
							<a href="new-booking.php">
								<div class="col-md-3 four-grid">
									<div class="four-agileinfo">
										...
										<div class="four-text">
											<h3>New Bookings</h3>
											<?php $sql1 = "SELECT id from tblcarwashbooking  where status='approved'";
						...
						<a href="manage-users.php">
							<div class="col-md-3 four-grid">
								<div class="four-w3ls">
									...
									<div class="four-text">
										<h3>Users</h3>
										<?php $sql6 = "SELECT id from users";
										$query6 = $dbh->prepare($sql6);
										$query6->execute();
										$results6 = $query6->fetchAll(PDO::FETCH_OBJ);
										$users = $query6->rowCount() - 1;
										?>
										<h4><?php echo htmlentities($users); ?></h4>
									</div>
								</div>
							</div>
						</a>
					...
					<div class="four-grids" style="padding: 30px">
						<div class="clearfix"></div>
					</div>
					<!--//four-grids here-->
