						...
						<div class="w3l-table-info">
							...
							<table id="table">
								...
								<tbody>
									...
									//Query
									$sql = "SELECT SQL_CALC_FOUND_ROWS *,tblcarwashbooking.id as bid  FROM tblcarwashbooking LEFT JOIN tblwashingpoints ON tblwashingpoints.id = tblcarwashbooking.carWashPoint LEFT JOIN  Services ON Services.id = tblcarwashbooking.packageType WHERE status = 'approved' LIMIT {$start}, {$perPage}";
