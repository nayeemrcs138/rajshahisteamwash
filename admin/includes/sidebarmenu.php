<div class="sidebar-menu">
	<header class="logo1" style="background: #f98f01;">
	...
	<div class="menu">
		<ul id="menu">
			...
			<li id="menu-academico"><a href="#"><i class="fa fa-files-o" aria-hidden="true"></i><span>Car Wash Booking</span> <span class="fa fa-angle-right" style="float: right"></span>
					<div class="clearfix"></div>
				</a>
				<ul id="menu-academico-sub">
					<li id="menu-academico-avaliacoes"><a href="pending-bookings.php">Pending</a></li>
			...
			<li id="menu-academico"><a href="#"><i class="fa fa-list-ul" aria-hidden="true"></i><span>Package</span> <span class="fa fa-angle-right" style="float: right"></span>
					<div class="clearfix"></div>
				</a>
				<ul id="menu-academico-sub">
			...
			<li id="menu-academico"><a href="#"><i class="fa fa-list-ul" aria-hidden="true"></i><span>Pages</span> <span class="fa fa-angle-right" style="float: right"></span>
				...
				<ul id="menu-academico-sub">
					<li id="menu-academico-avaliacoes"><a href="news.php">News & Events</a></li>
			</li>
