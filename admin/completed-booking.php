...
?>
	...
	<head>
		<title>RSW | Completed Bookings</title>
						...
						<div class="w3l-table-info">
							...
							<table id="table">
								...
								<tbody>
									...
									//Query
									$sql = "SELECT SQL_CALC_FOUND_ROWS *,tblcarwashbooking.id as bid  FROM tblcarwashbooking LEFT JOIN tblwashingpoints ON tblwashingpoints.id = tblcarwashbooking.carWashPoint LEFT JOIN  Services ON Services.id = tblcarwashbooking.packageType WHERE status = 'completed' LIMIT {$start}, {$perPage}";
									...
									if ($query1->rowCount() > 0) {
										foreach ($results as $result) {	?>
											<tr>
												...
												<td>
													<?php echo htmlentities($result->service) ?></td>
