...
?>
	...
	<head>
		<title>RSW | Add Car Washing Booking</title>
							...
							<div class="tab-pane active" id="horizontal-form">
								<form class="form-horizontal" name="washingpoint" method="post" enctype="multipart/form-data">
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="text" name="contactno" class="form-control" pattern="[0-9]{11}" title="11 numeric characters only" required placeholder="Mobile No.">
										</div>
									</div>
