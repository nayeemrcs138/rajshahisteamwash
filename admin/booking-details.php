						...
						<div class="w3l-table-info">
							...
							<table id="table">
								...
								<tbody>
									<?php
									$bid = $_GET['bid'];
									$sql =  "SELECT * FROM tblcarwashbooking LEFT JOIN tblwashingpoints ON tblwashingpoints.id = tblcarwashbooking.carWashPoint LEFT JOIN  Services ON Services.id = tblcarwashbooking.packageType WHERE tblcarwashbooking.id = '$bid'";
									$query = $dbh->prepare($sql);
									$query->execute();
									...
									<form method="post">
										<p>
											<select name="txntype" required class="form-control">
												...
												<option value="nNgad">Nagad</option>
