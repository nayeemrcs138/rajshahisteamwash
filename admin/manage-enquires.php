...
?>
	...
	<head>
		<title>RSW | Manage Enquiry</title>
						...
						<div class="w3l-table-info">
							...
							<table id="table">
								...
								<tbody>
									...
									$sql = "SELECT SQL_CALC_FOUND_ROWS * from tblenquiry LIMIT {$start}, {$perPage}";
									$enquiry = $dbh->prepare($sql);
									$enquiry->execute();
									$results = $enquiry->fetchAll(PDO::FETCH_OBJ);
