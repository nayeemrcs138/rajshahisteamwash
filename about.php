...
<head>
    ...
    <title>About | Rajshahi Steam Wash</title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="abt-img">
                        <img src="img/weare.jpg" alt="" />
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="abt-lft">
                        <h2> Rajshahi Steam Wash </h2>
                        <p>We are the first washing service provider in Rajshahi. By providing what you need when you need it, making customer satisfaction a top priority, offering amenities like free Wi-Fi and running our business in an environmentally responsible way, Rajshahi Steam Wash is able to offer an experience for every customer who visits us that’s simply unparalleled. Our full service hours are from 9.30AM to 11.30PM every day. So if you want to see just how easy and affordable it can be to keep your car in great shape, we encourage you to come visit us soon!</p>
                    </div>
                </div>
            </div>
        </div>
