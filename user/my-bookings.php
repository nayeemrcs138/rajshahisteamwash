...
?>
	...
	<head>
		<title>RSW | My Appointments</title>
	...
	<body>
		<div class="page-container">
			...
			<div class="left-content">
				...
				<!--heder end here-->
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="dashboard.php">Home</a><i class="fa fa-angle-right"></i>My Appointments</li>
				</ol>
						...
						<div class="w3l-table-info">
							...
							<table id="table">
								...
								<tbody>
									...
									//Query
									$sql = "SELECT SQL_CALC_FOUND_ROWS *,tblcarwashbooking.id as bid  FROM tblcarwashbooking LEFT JOIN tblwashingpoints ON tblwashingpoints.id = tblcarwashbooking.carWashPoint LEFT JOIN  Services ON Services.id = tblcarwashbooking.packageType WHERE  tblcarwashbooking.mobileNumber = '$mobile' LIMIT {$start}, {$perPage}";
