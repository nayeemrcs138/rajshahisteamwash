...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if (isset($_POST['book'])) {
		...
		$name = $dbh->query("SELECT * FROM users WHERE username='$uname'")->fetch()['name'];
		$mobile = $dbh->query("SELECT * FROM users WHERE username='$uname'")->fetch()['mobile'];
		...
		$sql = "INSERT INTO tblcarwashbooking(bookingId,packageType,carWashPoint,fullName,mobileNumber,washDate,washTime,message,status) VALUES(:bno,:ptype,:wpoint,:name,:mobile,:date,:time,:message,:status)";
...
?>
	...
	<head>
		<title>RSW | Make Appointment</title>
	...
	<body>
		<div class="page-container">
			...
			<div class="left-content">
				...
				<!--heder end here-->
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="dashboard.php">Home</a><i class="fa fa-angle-right"></i>Make Appointment </li>
				</ol>
				<!--grid-->
				<div class="grid-form">
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<select name="packagetype" required class="form-control">
												...
												?>
													<option value="<?php echo htmlentities($result->id); ?>"><?php echo htmlentities($result->service); ?> (<?php echo htmlentities($result->price); ?>)</option>
												<?php } ?>
											</select>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<select name="washtime" required class="form-control">
												...
												<option value="9.30 PM - 10.30 PM"> 9.30 PM - 10.30 PM </option>
												<option value="10.30 PM - 11.30 PM"> 10.30 PM - 11.30 PM </option>
											</select>
										</div>
									</div>
